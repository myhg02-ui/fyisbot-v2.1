...
# Asuntos de Netflix a filtrar (8 patrones)
FILTER_SUBJECTS = [
...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        try:
            ...
            # Optimización: solo últimos MAX_EMAILS_PROCESS
            ...
            for eid in reversed(last_emails):
                # Early exit: si ya encontramos MAX_RESULTS
                ...
                try:
                    ...
                    # Filtrar solo asuntos específicos de Netflix
    ...
    def extract_code(self, text):
        """Extraer código de 4 dígitos - Patrones mejorados"""
        patterns = [
            r'"'"'codigo.*?(\d{4})'"'"',
            r'"'"'code.*?(\d{4})'"'"',
